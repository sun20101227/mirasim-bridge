...
async function main() {
  ...
  if (!['status', 'summary', 'models', 'model', 'models/family', 'settings', 'test', 'profiles', 'profile/info', 'groups', 'login/start', 'login/complete', 'login/status',
    'accounts', 'account/host', 'account/unhost', 'account/pause', 'account/resume', 'account/access', 'account/check', 'membership/refresh', 'window-keeper', 'window-keeper/check', 'codex', 'logs'].includes(data.operation)) throw Error('unknown operation');
