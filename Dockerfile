...
COPY --chown=node:node scripts/deployment.js scripts/export-credential.js scripts/prepare-container.js scripts/container-config.js scripts/healthcheck.js scripts/account-login.js ./scripts/
